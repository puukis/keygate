      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'WebChat & Canvas', link: '/guide/webchat-and-canvas' },
            { text: 'Channel Actions & Voice', link: '/guide/channel-actions-and-voice' },
            { text: 'Media Understanding', link: '/guide/media-understanding' },
            { text: 'Memory Backends', link: '/guide/memory-backends' },
            { text: 'Remote Access', link: '/guide/remote-access' },
            { text: 'Tailscale Remote Access', link: '/guide/tailscale-remote' },
            { text: 'Managed SSH Tunnels', link: '/guide/ssh-tunnels' },
