...
hero:
  name: Keygate Documentation
  text: Complete guide for users, operators, and contributors
  tagline: Everything needed to install, run, secure, scale, and extend Keygate.
  image:
...
features:
  ...
  - title: Built for growth
    details: Structured docs that can scale with new channels, tools, workflows, and security requirements.
---

## Documentation map

- **Guide**: concepts and day-1 usage
